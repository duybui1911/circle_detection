...
from circle.MathFunc.MathUtils import MathUtils
...
class Line2:
    ...
    def Length(self):
        return sqrt(
            ((self.endPoint.x - self.startPoint.x) * (self.endPoint.x - self.startPoint.x)) 
            + ((self.endPoint.y - self.startPoint.y) * (self.endPoint.y - self.startPoint.y))
        )
