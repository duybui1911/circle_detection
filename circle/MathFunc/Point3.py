...
class Point3:
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and fabs(self.y - other.y) < tol 
            and fabs(self.z - other.z) < tol
        )
    ...
    def DistanceTo(self, other):
        d = sqrt(((self.x - other.x) * (self.x - other.x)) + ((self.y - other.y)
                 * (self.y - other.y)) + ((self.z - other.z) * (self.z - other.z)))
        return d
    ...
    def CalculateNormal(first, second, third):
        v1 = Vector3(second.x - first.x, second.y -
                     first.y, second.z - first.z)
        v2 = Vector3(third.x - second.x, third.y -
                     second.y, third.z - second.z)
        normal = v1.Cross(v2)
        normal.Normalize()
        return normal
    ...
    def AreCollinear(first, second, third):
        ...
        v1 = Vector3(first.x - second.x, first.y -
                     second.y, first.z - second.z)
